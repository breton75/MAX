...
//  qreal _voltage;
  ...
  qreal _current_angle_speed;
  qreal _current_turn_speed;
  quint32 _last_angle = 0; // для расчета скорости вращения
  quint32 _last_turn = 0; // для расчета скорости вращения
  time_t _last_time = time(NULL);

  time_t _seconds_passed = 0;
