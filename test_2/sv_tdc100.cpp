...
TDC1000::qres TDC1000::pullTDC1000(QSerialPort *serial)
{
  TDC1000::qres result;
...
TDC1000::qres TDC1000::writeReadTDC1000(QSerialPort *serial, QByteArray request, int answer_count)
{
  TDC1000::qres res;
  ...
  for(int i = 0; i < answer_count; i++) {
    ...
    if(res.answer.size() != sizeof(TDC1000::TDC1000_ANSWER)) {
      res.result = false;
